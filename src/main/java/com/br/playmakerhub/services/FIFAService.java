...
public class FIFAService {
    ...
    public String getInitialSeasonByFIFAVersion(String fifaVersion) {
        return switch (fifaVersion) {
            ...
            default -> "Versão do FIFA não existente";
        };
    }

    public List<String> getFifaVersions() {
        return List.of("FIFA 15", "FIFA 16", "FIFA 17", "FIFA 18", "FIFA 19", "FIFA 20", "FIFA 21", "FIFA 22", "FIFA 23", "EA FC 24");
    }

    public List<String> getFifaSeasons() {
        return List.of("temporada-14-15", "temporada-15-16", "temporada-16-17", "temporada-17-18", "temporada-18-19", "temporada-19-20", "temporada-20-21", "temporada-21-22", "temporada-22-23", "temporada-23-24");
    }
